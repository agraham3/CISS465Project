...
public:
    ...
    Text(Screen & s, bool _secret=false,  SDL_Color clr=BLACK, std::string hider="assets/pic/passwordHide.png", int fontsize=24, std::string m="");
    ~Text();
    ...
    void set_rect(SDL_Rect r) {rect = r;}
private:
    SDL_Rect rect;
    Image text_hider;
    bool secret;
